...
from transmission_layers.expectation_failure.real_data.hist_long7_intra_group_structural_contrast import (
    ...
    DEFAULT_HIST_LONG6_SOURCE_PATH,
    DEFAULT_REPORT_PATH,
    write_hist_long7,
)
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build HIST-LONG-7 intra-group structural contrast from local HIST-LONG-4/5B/6 artifacts only.")
    ...
    parser.add_argument("--hist-long6-source", default=DEFAULT_HIST_LONG6_SOURCE_PATH)
    ...
    artifact = write_hist_long7(
        ...
        hist_long6_source_path=args.hist_long6_source,
