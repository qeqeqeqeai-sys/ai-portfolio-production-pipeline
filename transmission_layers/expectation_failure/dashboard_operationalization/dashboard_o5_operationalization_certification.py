...
def build_dashboard_o5_artifact_inventory() -> OrderedDict:
    return OrderedDict([
        ...
        ("tests", [
            "tests/test_dashboard_o1_export_schema.py", "tests/test_dashboard_o2_supabase_contracts.py", "tests/test_dashboard_o3_supabase_write_adapter.py", "tests/test_dashboard_o4_streamlit_view_model.py", "tests/test_dashboard_o4_streamlit_app_import_path.py", "tests/test_dashboard_o5_operationalization_certification.py", "tests/test_dashboard_o6_supabase_read_adapter.py",
        ]),
        ("reports", [
            "reports/dashboard_o1_export_schema_report.md", "reports/dashboard_o2_supabase_contracts_report.md", "reports/dashboard_o3_supabase_write_adapter_report.md", "reports/dashboard_o4_streamlit_dashboard_report.md", "reports/dashboard_o5_operationalization_certification_report.md", "reports/dashboard_o6_supabase_read_adapter_report.md",
        ]),
    ])
