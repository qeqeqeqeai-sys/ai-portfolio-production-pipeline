...
from transmission_layers.asset_discovery.tier3h5.governance_history.artifacts import TREND_HISTORY_PATH, TREND_SUMMARY_PATH
...
def query_governance_trends(*, page: int = 1, page_size: int = 100, window: int | None = None, **filters: Any) -> dict[str, Any]:
