...
def build_records(seeds: list[DiscoverySeed], sgt_date: str) -> tuple[list[dict[str, Any]], list[dict[str, Any]], dict[str, Any], dict[str, Any]]:
    ...
    strict_diag["strict_identifier_summary_consistent"] = strict_diag["strict_identifier_matches_found"] == len(strict_diag["strict_identifier_sample_matches"]) or strict_diag["strict_identifier_matches_found"] > len(strict_diag["strict_identifier_sample_matches"])
    strict_diag["strict_identifier_log_summary_match"] = strict_diag["strict_identifier_summary_consistent"]
...
def main() -> int:
    ...
    print(f"[tier3h4] summary_consistent={evidence_summary.get('strict_identifier_summary_consistent',False)}")
