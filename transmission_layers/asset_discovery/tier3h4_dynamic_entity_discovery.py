...
def build_records(seeds: list[DiscoverySeed], sgt_date: str) -> tuple[list[dict[str, Any]], list[dict[str, Any]], dict[str, Any], dict[str, Any]]:
    ...
    strict_diag["strict_identifier_matches_found"] = strict_diag["strict_identifier_accepted_match_collection_size"]
    ...
    candidate_rows_with_ticker = sum(1 for r in candidate_rows if r.get("ticker"))
    candidate_rows_with_exchange = sum(1 for r in candidate_rows if r.get("exchange"))
    evidence_rows_with_ticker = strict_diag["strict_identifier_evidence_level_matches_found"]
    evidence_rows_with_exchange = strict_diag["strict_identifier_evidence_level_matches_found"]
    strict_diag["strict_identifier_rows_with_ticker"] = candidate_rows_with_ticker
    strict_diag["strict_identifier_rows_with_exchange"] = candidate_rows_with_exchange
    strict_diag["strict_identifier_evidence_rows_with_ticker"] = evidence_rows_with_ticker
    strict_diag["strict_identifier_evidence_rows_with_exchange"] = evidence_rows_with_exchange
    ...
    strict_identifier_runtime_vs_summary_delta = 0
    ...
    strict_identifier_log_summary_match = strict_identifier_runtime_vs_summary_delta == 0
