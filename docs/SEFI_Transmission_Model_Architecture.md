...
This document reconstructs SEFI's graph-based structural expectations transmission model from the available architecture notes, terminology standards, graph-foundation modules, transmission-layer modules, governance runbooks, and current Phase 5+ whitepaper source pack.
...
SEFI is best understood as a graph-based structural expectations and transmission system. Its earlier graph-foundation and propagation phases model how structural evidence, pressure, and transmission potential move across nodes and relationships. Later Phase 5+ layers do not replace that graph model; they operationalize observed transmission effects by converting bounded observations into observation facts, persisting governed facts in DB-2, retrieving them through OBS-QUERY, and presenting them through Consumption Products.
...
### 5.5 Intermediaries, corridors, directed seeding, and transmission paths
...
### 6.2 Causal and non-causal language
...
## 7. Propagation Mechanics

Only documented mechanics are included here.

### 7.1 Direct and single-hop propagation
...
### 7.4 Propagation memory and decay
...
### 7.5 Pressure accumulation and stress simulation
...
## 10. Relationship to DB-2 and Phase 5+
...
### 10.2 HIST-FACT, HIST-INTEL, and HIST-LONG
...
## 11. End-to-End Transmission Lifecycle
...
## 14. Recommended Source-Pack v1.2 Additions
